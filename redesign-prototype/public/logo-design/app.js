...
const markOptions = [
  { id: "ML1", name: "Reference Loop", mark: "reference-loop", accent: "#ffffff", family: "client sample" },
  { id: "ML2", name: "Infinity Blade", mark: "infinity-blade", accent: "#ef172f", family: "client sample" },
  { id: "ML3", name: "Liquid Link", mark: "liquid-link", accent: "#13d6ff", family: "paint loop" },
  { id: "ML4", name: "Split Rings", mark: "split-rings", accent: "#ef172f", family: "linked initials" },
  { id: "ML5", name: "Arena Badge", mark: "arena-badge", accent: "#ffffff", family: "stage badge" },
  { id: "ML6", name: "Razor Box", mark: "razor-box", accent: "#ef172f", family: "slash badge" },
  { id: "ML7", name: "Chrome Block", mark: "chrome-block", accent: "#ffffff", family: "bold ML monogram" },
  { id: "ML8", name: "Red Wing", mark: "red-wing", accent: "#ef172f", family: "speed mark" },
  { id: "ML9", name: "Cyan Wing", mark: "cyan-wing", accent: "#13d6ff", family: "speed mark" },
  { id: "ML10", name: "Diamond Link", mark: "diamond-link", accent: "#ffffff", family: "stage badge" },
  { id: "ML11", name: "Bolt Link", mark: "bolt-link", accent: "#ef172f", family: "electric mark" },
  { id: "ML12", name: "Orbit ML", mark: "orbit-ml", accent: "#13d6ff", family: "linked initials" },
  { id: "ML13", name: "Wide Motorsport", mark: "wide-motorsport", accent: "#ef172f", family: "motorsport" },
  { id: "ML14", name: "Hex Cut", mark: "hex-cut", accent: "#ffffff", family: "badge ML monogram" },
  { id: "ML15", name: "Ribbon ML", mark: "ribbon-ml", accent: "#13d6ff", family: "continuous ribbon" },
  { id: "ML16", name: "Slash Mono", mark: "slash-mono", accent: "#ef172f", family: "slash ML monogram" },
  { id: "ML17", name: "Twin Lens", mark: "twin-lens", accent: "#ffffff", family: "round ML monogram" },
  { id: "ML18", name: "Stage Crown", mark: "stage-crown", accent: "#ef172f", family: "stage badge" },
  { id: "ML19", name: "Minimal Link", mark: "minimal-link", accent: "#ffffff", family: "minimal ML monogram" },
  { id: "ML20", name: "Paint Strike", mark: "paint-strike", accent: "#13d6ff", family: "paint slash" },
];
