# Strict Crop Perspective Brief - M2 Living / Dining
...
- Unit code: M2
- Shot: Living / Dining
- Approximate cropped dimensions: 4.46 m x 3.12 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M2 Living / Dining

Unit: Type M2 Suite
Shot folder: 09_M2_type_m2_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **4.46 m x 3.12 m**.
Approximate position within whole unit plan: **17% from left**, **42% from top**.

What is inside the cropped/highlighted area:
Large living/dining zone in the lower-left/center with sofa, dining table, exterior glazing, and dry kitchen adjacency.

## Camera Intent

Eye-level from dry kitchen/dining edge toward living/window wall.
