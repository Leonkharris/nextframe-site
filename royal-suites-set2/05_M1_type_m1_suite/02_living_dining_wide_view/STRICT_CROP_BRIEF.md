# Strict Crop Perspective Brief - M1 Living / Dining
...
- Unit code: M1
- Shot: Living / Dining
- Approximate cropped dimensions: 4.15 m x 5.57 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M1 Living / Dining

Unit: Type M1 Suite
Shot folder: 05_M1_type_m1_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **4.15 m x 5.57 m**.
Approximate position within whole unit plan: **0% from left**, **41% from top**.

What is inside the cropped/highlighted area:
Large lower-left living/dining zone with sofa, table, dining set, window wall, and kitchen directly above.

## Camera Intent

Eye-level from kitchen/dining side toward living/window wall.
