# Strict Crop Perspective Brief - DK2 Kitchen / Pantry
...
- Set: Set 2 Cinematic
- Unit: Type DK2 Dual-Key Suite
- Unit code: DK2
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 5.34 m x 3.72 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK2 Kitchen / Pantry

Unit: Type DK2 Dual-Key Suite
Shot folder: 06_DK2_type_dk2_dual_key_suite\03_kitchen_pantry_wide_view
Source floor plan: ..\..\06_DK2_type_dk2_dual_key_suite\00_source_floor_plan.jpg
...
Approximate crop size from plan scale: **5.34 m x 3.72 m**.
Approximate position within whole unit plan: **12% from left**, **42% from top**.

What is inside the cropped/highlighted area:
Main residence dry kitchen and nearby wet-kitchen/service relationship. Dry kitchen connects to living/dining; wet kitchen only as background if naturally visible.

## Camera Intent

Eye-level from dry kitchen, one continuous frame, no split views.
