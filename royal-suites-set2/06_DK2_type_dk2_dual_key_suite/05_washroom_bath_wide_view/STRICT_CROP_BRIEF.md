# Strict Crop Perspective Brief - DK2 Washroom / Bath
...
- Unit code: DK2
- Shot: Washroom / Bath
- Approximate cropped dimensions: 3.1 m x 3.89 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK2 Washroom / Bath

Unit: Type DK2 Dual-Key Suite
Shot folder: 06_DK2_type_dk2_dual_key_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **3.1 m x 3.89 m**.
Approximate position within whole unit plan: **71% from left**, **41% from top**.

What is inside the cropped/highlighted area:
Main residence master bath core with shower/toilet/vanity area. Not Bath 1 and not the studio Bath 2.

## Camera Intent

Eye-level inside main bath, no oversized spa.
