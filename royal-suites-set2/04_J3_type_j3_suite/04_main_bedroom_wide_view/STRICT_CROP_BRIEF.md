# Strict Crop Perspective Brief - J3 Main Bedroom
...
- Unit code: J3
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.74 m x 3.08 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J3 Main Bedroom

Unit: Type J3 Suite
Shot folder: 04_J3_type_j3_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.74 m x 3.08 m**.
Approximate position within whole unit plan: **58% from left**, **7% from top**.

What is inside the cropped/highlighted area:
Enclosed upper-right master bedroom with bed, side tables, exterior wall/window, and wardrobe/bath adjacency.

## Camera Intent

Eye-level inside bedroom from entry/wardrobe side toward bed/window.
