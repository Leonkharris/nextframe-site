# Strict Crop Perspective Brief - J3 Kitchen / Pantry
...
- Unit code: J3
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 2.83 m x 3.08 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J3 Kitchen / Pantry

Unit: Type J3 Suite
Shot folder: 04_J3_type_j3_suite\03_kitchen_pantry_wide_view
Source floor plan: ..\..\04_J3_type_j3_suite\00_source_floor_plan.jpg
...
Approximate crop size from plan scale: **2.83 m x 3.08 m**.
Approximate position within whole unit plan: **0% from left**, **52% from top**.

What is inside the cropped/highlighted area:
Compact lower-left kitchen with counters and appliances, directly below dining zone and near entry.

## Camera Intent

Eye-level from kitchen side toward dining/living, showing compact footprint.
