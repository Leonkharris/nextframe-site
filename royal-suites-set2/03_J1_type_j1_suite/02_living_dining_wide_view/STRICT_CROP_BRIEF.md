# Strict Crop Perspective Brief - J1 Living / Dining
...
- Unit code: J1
- Shot: Living / Dining
- Approximate cropped dimensions: 3.47 m x 4.64 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J1 Living / Dining

Unit: Type J1 Suite
Shot folder: 03_J1_type_j1_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **3.47 m x 4.64 m**.
Approximate position within whole unit plan: **53% from left**, **2% from top**.

What is inside the cropped/highlighted area:
Right-side living/dining field with sofa at upper-right, living table, dining table, and kitchen below/right.
