# Strict Crop Perspective Brief - J4 Main Bedroom
...
- Unit code: J4
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.93 m x 3.4 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J4 Main Bedroom

Unit: Type J4 Suite
Shot folder: 08_J4_type_j4_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.93 m x 3.4 m**.
Approximate position within whole unit plan: **1% from left**, **3% from top**.

What is inside the cropped/highlighted area:
Upper-left enclosed master bedroom with bed, side tables, exterior wall/window, and nearby master bath.

## Camera Intent

Eye-level from bedroom entry toward bed/window.
