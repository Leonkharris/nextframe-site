# Strict Crop Perspective Brief - DK1 Living / Dining
...
- Unit code: DK1
- Shot: Living / Dining
- Approximate cropped dimensions: 4.07 m x 5.36 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK1 Living / Dining

Unit: Type DK1 Dual-Key Suite
Shot folder: 10_DK1_type_dk1_dual_key_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **4.07 m x 5.36 m**.
Approximate position within whole unit plan: **37% from left**, **11% from top**.

What is inside the cropped/highlighted area:
Main-side living/dining zone in the center/right of the plan, with sofa/living, dining, and kitchen below; studio side remains separate on the left.

## Camera Intent

Eye-level from kitchen/dining side toward main living/window wall.
