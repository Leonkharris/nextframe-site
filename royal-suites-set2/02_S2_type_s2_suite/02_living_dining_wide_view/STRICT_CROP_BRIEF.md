# Strict Crop Perspective Brief - S2 Living / Dining
...
- Unit code: S2
- Shot: Living / Dining
- Approximate cropped dimensions: 6.32 m x 3.12 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S2 Living / Dining

Unit: Type S2 Suite
Shot folder: 02_S2_type_s2_suite\02_living_dining_wide_view
Source floor plan: ..\..\02_S2_type_s2_suite\00_source_floor_plan.jpg
...
Approximate crop size from plan scale: **6.32 m x 3.12 m**.
Approximate position within whole unit plan: **23% from left**, **5% from top**.

What is inside the cropped/highlighted area:
Open dining and living area across upper/right side, with sofa, dining table, window wall, and pantry adjacency.

## Camera Intent

Eye-level from pantry/dining side toward living/window side.
