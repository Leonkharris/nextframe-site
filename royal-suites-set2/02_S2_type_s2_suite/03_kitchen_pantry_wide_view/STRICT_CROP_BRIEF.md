# Strict Crop Perspective Brief - S2 Kitchen / Pantry
...
- Unit code: S2
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 4.06 m x 1.52 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S2 Kitchen / Pantry

Unit: Type S2 Suite
Shot folder: 02_S2_type_s2_suite\03_kitchen_pantry_wide_view
...
Approximate crop size from plan scale: **4.06 m x 1.52 m**.
Approximate position within whole unit plan: **3% from left**, **36% from top**.

What is inside the cropped/highlighted area:
Central pantry run across middle-left with sink/cooktop/counter, close to dining/living and bath core.

## Camera Intent

Eye-level parallel to pantry run with open suite visible.
