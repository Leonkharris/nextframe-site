# Strict Crop Perspective Brief - S1 Living / Dining
...
- Unit code: S1
- Shot: Living / Dining
- Approximate cropped dimensions: 5.22 m x 4.75 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S1 Living / Dining

Unit: Type S1 Suite
Shot folder: 01_S1_type_s1_suite\02_living_dining_wide_view
Source floor plan: ..\..\01_S1_type_s1_suite\00_source_floor_plan.jpg
...
Approximate crop size from plan scale: **5.22 m x 4.75 m**.
Approximate position within whole unit plan: **0% from left**, **1% from top**.

What is inside the cropped/highlighted area:
Open studio living/dining field: sofa/living zone, dining/table area, window end, and adjacent bed zone visible without adding partitions.

## Camera Intent

Eye-level from pantry/kitchen side toward living/window wall.
