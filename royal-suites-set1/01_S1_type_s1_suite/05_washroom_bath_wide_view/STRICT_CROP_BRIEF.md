# Strict Crop Perspective Brief - S1 Washroom / Bath
...
- Unit code: S1
- Shot: Washroom / Bath
- Approximate cropped dimensions: 2.9 m x 3.66 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S1 Washroom / Bath

Unit: Type S1 Suite
Shot folder: 01_S1_type_s1_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **2.9 m x 3.66 m**.
Approximate position within whole unit plan: **43% from left**, **47% from top**.

What is inside the cropped/highlighted area:
Compact master bath core with vanity, toilet, shower, and wardrobe adjacency.

## Camera Intent

Eye-level inside compact bath, showing fixtures without enlarging room.
