# Strict Crop Perspective Brief - S1 Main Bedroom
...
- Unit code: S1
- Shot: Main Bedroom
- Approximate cropped dimensions: 3.48 m x 4.5 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S1 Main Bedroom

Unit: Type S1 Suite
Shot folder: 01_S1_type_s1_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **3.48 m x 4.5 m**.
Approximate position within whole unit plan: **30% from left**, **3% from top**.

What is inside the cropped/highlighted area:
Open studio bed/sleeping zone beside living, not a separate enclosed bedroom.

## Camera Intent

Eye-level from living/pantry edge toward bed/window zone.
