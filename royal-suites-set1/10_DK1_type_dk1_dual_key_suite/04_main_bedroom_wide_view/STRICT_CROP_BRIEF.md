# Strict Crop Perspective Brief - DK1 Main Bedroom
...
- Unit code: DK1
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.37 m x 3.61 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK1 Main Bedroom

Unit: Type DK1 Dual-Key Suite
Shot folder: 10_DK1_type_dk1_dual_key_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.37 m x 3.61 m**.
Approximate position within whole unit plan: **77% from left**, **9% from top**.

What is inside the cropped/highlighted area:
Right-side enclosed master bedroom with bed and nearby bath/wardrobe relationship.

## Camera Intent

Eye-level inside master bedroom from entry side toward bed/window.
