# Strict Crop Perspective Brief - S2 Main Bedroom
...
- Unit code: S2
- Shot: Main Bedroom
- Approximate cropped dimensions: 3.33 m x 2.7 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S2 Main Bedroom

Unit: Type S2 Suite
Shot folder: 02_S2_type_s2_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **3.33 m x 2.7 m**.
Approximate position within whole unit plan: **56% from left**, **53% from top**.

What is inside the cropped/highlighted area:
Open-adjacent master bed zone at lower-right, with bedside tables and nearby wardrobe/bath core.

## Camera Intent

Eye-level from suite center toward bed/window side.
