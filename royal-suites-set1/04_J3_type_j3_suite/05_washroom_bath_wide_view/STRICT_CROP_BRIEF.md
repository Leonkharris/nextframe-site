# Strict Crop Perspective Brief - J3 Washroom / Bath
...
- Unit code: J3
- Shot: Washroom / Bath
- Approximate cropped dimensions: 2.44 m x 2.57 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J3 Washroom / Bath

Unit: Type J3 Suite
Shot folder: 04_J3_type_j3_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **2.44 m x 2.57 m**.
Approximate position within whole unit plan: **62% from left**, **33% from top**.

What is inside the cropped/highlighted area:
Master bath on right side with compact fixture arrangement and door swing preserved.

## Camera Intent

Eye-level inside bath, no spa enlargement.
