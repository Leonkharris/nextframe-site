# Strict Crop Perspective Brief - J1 Washroom / Bath
...
- Unit code: J1
- Shot: Washroom / Bath
- Approximate cropped dimensions: 3.38 m x 2.58 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J1 Washroom / Bath

Unit: Type J1 Suite
Shot folder: 03_J1_type_j1_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **3.38 m x 2.58 m**.
Approximate position within whole unit plan: **9% from left**, **41% from top**.

What is inside the cropped/highlighted area:
Master bath core beside master bedroom with shower, toilet, vanity, and door swing constraints.
