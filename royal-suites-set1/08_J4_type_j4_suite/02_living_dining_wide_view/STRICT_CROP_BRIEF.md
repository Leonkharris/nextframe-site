# Strict Crop Perspective Brief - J4 Living / Dining
...
- Unit code: J4
- Shot: Living / Dining
- Approximate cropped dimensions: 3.6 m x 5.66 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J4 Living / Dining

Unit: Type J4 Suite
Shot folder: 08_J4_type_j4_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **3.6 m x 5.66 m**.
Approximate position within whole unit plan: **49% from left**, **2% from top**.

What is inside the cropped/highlighted area:
Right-side living/dining stack with living at upper-right, dining middle-right, and kitchen below/right. Left-side bedroom/study zones remain enclosed.

## Camera Intent

Eye-level from kitchen/dining side toward living/window side.
