# Strict Crop Perspective Brief - M1 Washroom / Bath
...
- Unit code: M1
- Shot: Washroom / Bath
- Approximate cropped dimensions: 2.38 m x 3.74 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M1 Washroom / Bath

Unit: Type M1 Suite
Shot folder: 05_M1_type_m1_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **2.38 m x 3.74 m**.
Approximate position within whole unit plan: **77% from left**, **6% from top**.

What is inside the cropped/highlighted area:
Upper-right master bath with tub/shower, toilet, vanity, and exterior wall/window constraints.

## Camera Intent

Eye-level inside master bath, compact to plan.
