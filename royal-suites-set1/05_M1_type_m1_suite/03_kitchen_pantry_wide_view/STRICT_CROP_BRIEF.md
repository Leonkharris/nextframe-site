# Strict Crop Perspective Brief - M1 Kitchen / Pantry
...
- Unit code: M1
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 3.62 m x 3.22 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M1 Kitchen / Pantry

Unit: Type M1 Suite
Shot folder: 05_M1_type_m1_suite\03_kitchen_pantry_wide_view
Source floor plan: ..\..\05_M1_type_m1_suite\00_source_floor_plan.jpg
...
Approximate crop size from plan scale: **3.62 m x 3.22 m**.
Approximate position within whole unit plan: **0% from left**, **9% from top**.

What is inside the cropped/highlighted area:
Compact upper-left kitchen near entry, directly above dining/living. It is not a large L-shaped showroom kitchen.

## Camera Intent

Eye-level from compact kitchen toward dining/living below.
