# Strict Crop Perspective Brief - M1 Main Bedroom
...
- Unit code: M1
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.91 m x 3.74 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M1 Main Bedroom

Unit: Type M1 Suite
Shot folder: 05_M1_type_m1_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.91 m x 3.74 m**.
Approximate position within whole unit plan: **72% from left**, **58% from top**.

What is inside the cropped/highlighted area:
Enclosed lower-right master bedroom with exterior glazing and wardrobe/bath adjacency.

## Camera Intent

Eye-level from bedroom entry side toward bed/window.
