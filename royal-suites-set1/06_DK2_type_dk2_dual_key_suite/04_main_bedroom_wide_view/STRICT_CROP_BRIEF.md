# Strict Crop Perspective Brief - DK2 Main Bedroom
...
- Unit code: DK2
- Shot: Main Bedroom
- Approximate cropped dimensions: 3.02 m x 3.89 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK2 Main Bedroom

Unit: Type DK2 Dual-Key Suite
Shot folder: 06_DK2_type_dk2_dual_key_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **3.02 m x 3.89 m**.
Approximate position within whole unit plan: **72% from left**, **71% from top**.

What is inside the cropped/highlighted area:
Lower-right main residence master bedroom with bed, side tables, wardrobe/bath adjacency, and normal exterior wall glazing.

## Camera Intent

Eye-level inside enclosed bedroom from entry/wardrobe side.
