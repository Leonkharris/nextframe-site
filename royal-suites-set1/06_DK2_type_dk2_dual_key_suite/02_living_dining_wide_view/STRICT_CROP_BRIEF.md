# Strict Crop Perspective Brief - DK2 Living / Dining
...
- Unit code: DK2
- Shot: Living / Dining
- Approximate cropped dimensions: 4.82 m x 4.85 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK2 Living / Dining

Unit: Type DK2 Dual-Key Suite
Shot folder: 06_DK2_type_dk2_dual_key_suite\02_living_dining_wide_view
...
Approximate crop size from plan scale: **4.82 m x 4.85 m**.
Approximate position within whole unit plan: **11% from left**, **64% from top**.

What is inside the cropped/highlighted area:
Main residence lower-left/lower-center living/dining zone with sofa, dining table, window wall, and dry kitchen adjacency. Not the top studio suite.

## Camera Intent

Eye-level single-frame camera from dry kitchen/dining side toward main living.
