# Strict Crop Perspective Brief - M2 Main Bedroom
...
- Unit code: M2
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.66 m x 3.12 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - M2 Main Bedroom

Unit: Type M2 Suite
Shot folder: 09_M2_type_m2_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.66 m x 3.12 m**.
Approximate position within whole unit plan: **81% from left**, **52% from top**.

What is inside the cropped/highlighted area:
Right-side master bedroom zone with bed, wardrobe/bath adjacency, and exterior wall condition.
