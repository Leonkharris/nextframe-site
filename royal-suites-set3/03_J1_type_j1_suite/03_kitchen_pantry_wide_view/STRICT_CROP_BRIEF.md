# Strict Crop Perspective Brief - J1 Kitchen / Pantry
...
- Unit code: J1
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 2.69 m x 3.09 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J1 Kitchen / Pantry

Unit: Type J1 Suite
Shot folder: 03_J1_type_j1_suite\03_kitchen_pantry_wide_view
...
Approximate crop size from plan scale: **2.69 m x 3.09 m**.
Approximate position within whole unit plan: **65% from left**, **60% from top**.

What is inside the cropped/highlighted area:
Lower-right kitchen zone connected to dining/living, with compact counters and cooking fixtures.

## Camera Intent

Eye-level from kitchen looking back to dining/living.
