# Strict Crop Perspective Brief - S2 Washroom / Bath
...
- Unit code: S2
- Shot: Washroom / Bath
- Approximate cropped dimensions: 2.73 m x 2.53 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - S2 Washroom / Bath

Unit: Type S2 Suite
Shot folder: 02_S2_type_s2_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **2.73 m x 2.53 m**.
Approximate position within whole unit plan: **4% from left**, **56% from top**.

What is inside the cropped/highlighted area:
Compact master bath core with shower, toilet, vanity, and adjacent wardrobes.

## Camera Intent

Eye-level inside compact bath.
