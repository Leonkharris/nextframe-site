# Strict Crop Perspective Brief - DK1 Washroom / Bath
...
- Unit code: DK1
- Shot: Washroom / Bath
- Approximate cropped dimensions: 3.05 m x 3.71 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - DK1 Washroom / Bath

Unit: Type DK1 Dual-Key Suite
Shot folder: 10_DK1_type_dk1_dual_key_suite\05_washroom_bath_wide_view
...
Approximate crop size from plan scale: **3.05 m x 3.71 m**.
Approximate position within whole unit plan: **68% from left**, **45% from top**.

What is inside the cropped/highlighted area:
Main-side bath core near the bedrooms, not the studio bath; compact fixtures and door swings preserved.

## Camera Intent

Eye-level inside main bath.
