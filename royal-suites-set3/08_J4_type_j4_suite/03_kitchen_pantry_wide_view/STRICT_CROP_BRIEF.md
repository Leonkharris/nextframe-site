# Strict Crop Perspective Brief - J4 Kitchen / Pantry
...
- Unit code: J4
- Shot: Kitchen / Pantry
- Approximate cropped dimensions: 3.26 m x 2.96 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J4 Kitchen / Pantry

Unit: Type J4 Suite
Shot folder: 08_J4_type_j4_suite\03_kitchen_pantry_wide_view
...
Approximate crop size from plan scale: **3.26 m x 2.96 m**.
Approximate position within whole unit plan: **54% from left**, **54% from top**.

What is inside the cropped/highlighted area:
Lower-right kitchen zone near the entry/study relationship, connected to dining/living; do not turn into oversized showroom kitchen.

## Camera Intent

Eye-level from kitchen toward dining/living.
