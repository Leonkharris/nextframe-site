# Strict Crop Perspective Brief - J2 Main Bedroom
...
- Unit code: J2
- Shot: Main Bedroom
- Approximate cropped dimensions: 2.76 m x 3.31 m
- Output: vertical 9:16 photorealistic perspective render

## Cropped Area Description

# Spatial Preflight - J2 Main Bedroom

Unit: Type J2 Suite
Shot folder: 07_J2_type_j2_suite\04_main_bedroom_wide_view
...
Approximate crop size from plan scale: **2.76 m x 3.31 m**.
Approximate position within whole unit plan: **59% from left**, **4% from top**.

What is inside the cropped/highlighted area:
Upper-right enclosed master bedroom with bed, side tables, exterior wall/window condition, and nearby wardrobe/bath adjacency.

## Camera Intent

Eye-level from bedroom entry/wardrobe side toward bed/window.
